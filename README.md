...
1. **NVIDIA Nemotron-Nano-12B-V2-VL** — Primary cloud inference
2. **HuggingFace ViT (LaurianeMD/vit-skin-disease)** — Secondary vision transformer
3. **Local TFLite/Keras CNN (EfficientNetV2B0)** — Final on-device fallback
